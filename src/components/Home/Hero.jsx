...
const Hero = () => {
  return (
    <div className='h-fit w-full bg-[conic-gradient(from_var(--rotate),var(--primary),var(--dark-blue))] animate-[rot_3s_linear_infinite] py-1 flex justify-center items-center rounded-2xl'>
